...
def upgrade():
    ...
    op.add_column(
        "dbh_data", sa.Column("forecast_upper_bound", sa.Float(), nullable=True)
    )
    op.add_column(
        "dbh_data", sa.Column("forecast_lower_bound", sa.Float(), nullable=True)
    )
    op.add_column(
        "dbh_data", sa.Column("forecast_explanation", sa.Text(), nullable=True)
    )
