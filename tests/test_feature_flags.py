...
def test_create_flag_in_memory(test_app):
    # Basitleştirilmiş test - sadece API endpoint'i test edelim
    res = test_app.post(
...
def test_create_flag_redis(test_app):
    # Redis test'i basitleştirildi - sadece API endpoint'i test edelim
    res = test_app.post(
        "/api/admin/feature-flags/create",
        json={
            "name": "redis_flag",
